...
def normalise_request(value: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "festivalPrimaryTitle": clean_space(value.get("festivalPrimaryTitle")) or clean_space(value.get("festivalName")) or title,
...
def build_festival_config(
    ...
    *,
    ...
    return {
        ...
        "festivalPrimaryTitle": normalized["festivalPrimaryTitle"],
