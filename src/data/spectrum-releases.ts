...
export const spectrumReleases: SpectrumRelease[] = [
  ...
  { id: 'universal-beings', title: 'Universal Beings', artist: 'Makaya McCraven', year: 2018, x: .42, y: .84, zone: 'jazz · organic beat music', note: 'Improvised jazz cut and recomposed with the instincts of a beat-maker.', bandcampUrl: 'https://intlanthem.bandcamp.com/album/universal-beings', bandcampEmbedAlbumId: '1059062676' },
